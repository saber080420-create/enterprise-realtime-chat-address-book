...
<template>
  <section class="ai-assistant">
    <header>
      ...
      <el-button :disabled="busy || !messages.length" @click="messages = []; error = ''">新对话</el-button>
    </header>
    ...
    <el-alert v-if="status && !status.configured" :closable="false" type="warning" title="AI 尚未启用，请在后端配置 DEEPSEEK_API_KEY 后重启服务。" />
